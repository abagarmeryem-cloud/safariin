      ...
      <Layout>
        <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
          ...
          <div className="flex flex-col mt-10">
            <p className="text-1xl md:text-3xl font-outfit mb-4">
              {room.description}
            </p>
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  {room.rooms.map((item, index) => (
                    <div
                      key={index}
                      className="flex items-center gap-2 px-3 py-2 rounded-full bg-gray border border-customBlue hover:bg-safari-slate  hover:text-white transition-colors"
                    >
          ...
          >
            ...
            <button
              type="submit"
              className="bg-safari-slate hover:bg-primary-dull
          ...
          <div className="max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500"></div>
          ...
          <div className="max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500">
            <p>
              Les clients seront attribués dans la meilleure chambre ou suite
              disponible selon les disponibilités. Vous profiterez d’un espace
              confortable et décoré dans le style authentique de Meknès, offrant
              une atmosphère chaleureuse et traditionnelle. Le tarif affiché
              correspond à deux personnes ; veuillez ajuster le nombre de
              voyageurs lors de la réservation afin d’obtenir le prix exact pour
              les groupes. Selon les disponibilités, les chambres peuvent être
              situées à différents étages ou dans différentes parties de
              l’établissement, tout en garantissant confort, tranquillité et une
              véritable expérience marocaine.
            </p>
          </div>
        </div>
      </Layout>
