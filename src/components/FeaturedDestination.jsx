...
const FeaturedDestination  = () => {
  ...
  return (
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 bg-slate-50 py-20 dark:bg-customGrey'>
      ...
      rounded bg-white hover:bg-gray-50 dark:text-safari-dark transition-all cursor-pointer'>Afficher Tous les Hotels
      </button>
    </div>
  )
}
